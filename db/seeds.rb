...
namibia = Location.create(name: "Namibia", description: "Africa", tour_id: visit_namibia.id, guide_id: beata.id)

thailand = Location.create(name: "Thailand", description: "Asia", tour_id: visit_thailand.id, guide_id: prayat.id)

japan = Location.create(name: "Japan", description: "Asia", tour_id: visit_japan.id, guide_id: raul.id)

india = Location.create(name: "India", description: "Asia", tour_id: visit_india.id, guide_id: prayat.id)

brazil = Location.create(name: "Brazil", description: "South America", tour_id: visit_brazil.id, guide_id: beata.id)

mexico = Location.create(name: "Mexico", description: "North America", tour_id: visit_mexico.id, guide_id: imani.id)

morocco = Location.create(name: "Morocco", description: "Africa", tour_id: visit_morocco.id, guide_id: florentina.id)

alaska = Location.create(name: "Alaska", description: "North America", tour_id: visit_alaska.id, guide_id: imani.id)

spain = Location.create(name: "Spain", description: "Europe", tour_id: visit_spain.id, guide_id: florentina.id)
...
Addon.create(name: "Bazaar Tour", price: 100, location_id: morocco.id)
Addon.create(name: "Surf Lessons", price: 100, location_id: mexico.id)
Addon.create(name: "Animal Sanctuary Meet and Greet", price: 100, location_id:india.id)
Addon.create(name: "Kayaking", price: 100, location_id: alaska.id)
Addon.create(name: "Wood Block Print", price: 100, location_id: japan.id)
Addon.create(name: "Tea Ceremony", price: 100, location_id:japan.id)
Addon.create(name: "Tango Lessons", price: 100, location_id: spain.id)
Addon.create(name: "Olive Oil Tasting", price: 100, location_id: greece.id)
Addon.create(name: "Wine Tasting", price: 100, location_id: greece.id)
